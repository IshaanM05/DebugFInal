...
// Publishers and Subscribers
    ...
    rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr ground_points_output_rviz_pub;
...
// Private Functions
     ...
     * @return void
     */
    void publishMarkerArray(visualization_msgs::msg::Marker::_type_type type, std::string ns, std::string frame_id, std::vector<std::vector<std::vector<double>>> positions_colours,rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr publisher, bool del_markers, std::vector<double> scales, const rclcpp::Time& stamp);
