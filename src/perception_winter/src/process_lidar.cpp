...
// // These should match the model's expected input shape.
// // The shape is (1, NUM_BINS, NUM_CHANNELS).
// constexpr int NUM_BINS = 10;
// constexpr int NUM_CHANNELS = 2; // Channel 1: point count, Channel 2: avg intensity
// constexpr float CONFIDENCE_THRESHOLD = 0.99; // Tune this threshold as needed
...
// // In src/perception_winter/src/process_lidar.cpp
...
//         feature_vector[i * NUM_CHANNELS + 0] = static_cast<float>(point_count[i]);
...
//     // --- FIX IS HERE ---
//     // The Run function needs const char*, so we create a temporary vector of pointers.
...
//     // Use the new temporary vectors in the Run command
...
// These should match the model's expected input shape.
constexpr int NUM_BINS = 10;
constexpr int NUM_CHANNELS = 2; // Channel 1: normalized point count, Channel 2: avg intensity
constexpr float CONFIDENCE_THRESHOLD = 0.99f; // Tune this threshold as needed
